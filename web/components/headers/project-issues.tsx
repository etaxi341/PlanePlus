...
export const ProjectIssuesHeader: React.FC = observer(() => {
  ...
  return (
    <>
      ...
      />
      <div className="relative z-10 flex h-[3.75rem] w-full flex-shrink-0 flex-row items-center justify-between gap-x-2 gap-y-4 border-b border-custom-border-200 bg-custom-sidebar-background-100 p-4 flex-wrap h-auto">
        <div className="flex w-full md:w-auto flex-grow items-center gap-2 overflow-ellipsis whitespace-nowrap">
